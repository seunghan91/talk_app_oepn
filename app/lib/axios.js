...
const mockResponses = {
  ...
  // 공지사항 카테고리 목록 API
  '/api/v1/announcement_categories': (config) => {
    return {
      categories: [
        {
          id: 1,
      ...
      announcements: [
        {
          ...
          is_published: true,
          is_hidden: false,
          created_at: new Date(now - oneDay * 7).toISOString(),
          updated_at: new Date(now - oneDay * 7).toISOString(),
          published_at: new Date(now - oneDay * 7).toISOString()
        },
        {
          id: 2,
          ...
          is_published: true,
          is_hidden: false,
          created_at: new Date(now - oneDay * 3).toISOString(),
          updated_at: new Date(now - oneDay * 3).toISOString(),
          published_at: new Date(now - oneDay * 3).toISOString()
        },
        {
          id: 3,
          ...
          is_published: true,
          is_hidden: true,
          created_at: new Date(now - oneDay * 1).toISOString(),
          updated_at: new Date(now - oneDay * 1).toISOString(),
          published_at: new Date(now - oneDay * 1).toISOString()
        }
      ],
      pagination: {
        total: 3,
  ...
  '/api/v1/announcements/([0-9]+)': (config, matches) => {
    ...
    return announcements[id] || { error: '공지사항을 찾을 수 없습니다.' };
  },
